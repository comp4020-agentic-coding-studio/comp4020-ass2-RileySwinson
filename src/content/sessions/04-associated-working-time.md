...
same room. The times of both are set out above.

Each workshop delivers three hours of content. The first hour of content is
delivered in the workshop. Students complete the remaining content in the
drop-in session.

The drop-in session is not scheduled teaching.
