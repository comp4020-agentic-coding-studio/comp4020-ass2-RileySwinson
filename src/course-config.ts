...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "An introduction to completing a university course under the conditions " +
    "in which it is offered. Students learn to locate, interpret and satisfy " +
    "course requirements, including requirements that are not published.",
  tags: ["compliance", "administration", "self-advocacy"],
